...
The connector also continues to emit the previous OpenCensus-based metrics
through OpenCensus so that existing dashboards and alerts keep working. This
emission is deprecated and will be removed in a future release.

> **Migrating from a previous release?** See
> [`OTEL_MIGRATION.md`](./OTEL_MIGRATION.md) for the OpenCensus → OpenTelemetry
> migration guide.
